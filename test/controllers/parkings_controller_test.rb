...
class ParkingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking" do
    assert_difference('Parking.count') do
      post parkings_url, params: { parking: { spot_id: @parking.spot_id, vehicle_id: @parking.vehicle_id } }
    end
  ...
  test "should update parking" do
    patch parking_url(@parking), params: { parking: { spot_id: @parking.spot_id, vehicle_id: @parking.vehicle_id } }
